...
namespace FluencyHub.Application.PaymentProcessing.Services;

public class PaymentService : IPaymentApplicationService
{
    private readonly IEnrollmentRepository _enrollmentRepository;
    private readonly Application.Common.Interfaces.IPaymentRepository _paymentRepository;
    private readonly IPaymentGateway _paymentGateway;
    private readonly ILogger<PaymentService> _logger;

    public PaymentService(
        IEnrollmentRepository enrollmentRepository,
        Application.Common.Interfaces.IPaymentRepository paymentRepository,
