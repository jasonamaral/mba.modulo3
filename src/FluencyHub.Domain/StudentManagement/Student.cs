...
public class Student : BaseEntity
{
    ...
    public void AddCertificate(Guid courseId, string title)
    {
        ...
        var enrollment = _enrollments.FirstOrDefault(e => e.CourseId == courseId && e.Status == EnrollmentStatus.Completed);
        if (enrollment == null)
            throw new InvalidOperationException("Student has not completed this course");
