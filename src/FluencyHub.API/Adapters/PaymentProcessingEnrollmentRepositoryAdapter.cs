...
public class PaymentProcessingEnrollmentRepositoryAdapter : IEnrollmentRepository
{
    private readonly EnrollmentRepository _repository;

    public PaymentProcessingEnrollmentRepositoryAdapter(EnrollmentRepository repository)
    {
